-- Datenbankschema von Lifeline
-- Muss zu docs/spec/D1-datenmodell.md, docs/spec/D2-datentypenverzeichnis.md
-- und docs/arch/A08-Querschnittskonzepte.md (8.1 Validierung) passen.
--
