...
export default function Timeline({
  ...
  // Eingabe im Jahresfeld; wird erst bei vier Ziffern im gültigen Bereich
  // übernommen und beim Verlassen auf das angezeigte Jahr zurückgesetzt.
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              onChange={(event) => {
                ...
                setYearDraft(value)
                if (value.length === 4) changeYear(Number(value))
              }}
              onBlur={() => setYearDraft(String(selectedYear))}
