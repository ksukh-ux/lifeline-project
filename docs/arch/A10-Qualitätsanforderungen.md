...
| Performance | N1 (Spec, Ladezeit) | Mittel |
...
nichtfunktionalen Anforderungen der Spec (N1) auf – deshalb hier mit
der dort festgelegten Priorität ergänzt, nicht weggelassen.
...
| QS-03 | Erweiterbarkeit | Eine neue Event-Kategorie (z. B. "Weiterbildung") soll ergänzt werden | Änderung ist an einer zentralen Stelle möglich, keine Anpassung der Kernlogik nötig | Umsetzbar in < 30 Minuten, < 3 geänderte Dateien (zentrale Kategorie-Whitelist, siehe Kapitel 8.2) |
