...
| Session | Serverseitig gespeicherter Anmeldezustand einer Nutzerin/eines Nutzers (Kapitel 8.2) || Origin | Kombination aus Protokoll, Host und Port (z. B. `http://localhost:5173`); Browser trennen Cookies und Anfragen nach Origin (Kapitel 8.2) |
