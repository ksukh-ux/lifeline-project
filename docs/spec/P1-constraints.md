...
| **Konsequenz** | Versionierung mit Git/GitHub, Commit-Nachrichten nach Conventional Commits. Jeder Abgabestand wird als Git-Tag markiert (siehe `NFR-14a-01`, umgesetzt u. a. als Tag `v0.1-mvp`). |
